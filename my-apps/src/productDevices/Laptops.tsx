...
const laptops: Product[] = [
  { id: 1, name: "H525", category: "Laptop", price: 599, image: h525 },
  { id: 2, name: "Dell XPS", category: "Laptop", price: 1299, image: LaptopDell },
  { id: 3, name: "MacBook Air", category: "Laptop", price: 999, image: macbookair },
]
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6 text-center">Laptops</h1>
